...
# URLs to fetch from
JSON_QUOTES_URL = "https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=gbp"
...
while True:
    ...
    try:
        for y, row in enumerate(GBP):
            for x, c in enumerate(row):
                display1.pixel(x + 0, y + 0, c)
    except:
        print('problem with GBP')
