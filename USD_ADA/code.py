...
# URLs to fetch from
JSON_QUOTES_URL = "https://api.coingecko.com/api/v3/simple/price?ids=cardano&vs_currencies=usd"
...
while True:
    ...
    ada_price = a['cardano']['usd']

    print('This is ADA price: ' + str(ada_price))
    string = str(ada_price)
