...
# URLs to fetch from
JSON_QUOTES_URL = "https://api.coingecko.com/api/v3/simple/price?ids=litecoin&vs_currencies=usd"
...
while True:
    ...
    ltc_price = a['litecoin']['usd']

    print('This is LTC price: ' + str(ltc_price))
    string = str(ltc_price)
