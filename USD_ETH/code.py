...
# URLs to fetch from
JSON_QUOTES_URL = "https://api.coingecko.com/api/v3/simple/price?ids=ethereum&vs_currencies=usd"
...
while True:
    ...
    eth_price = ("%.1f" % eth_price)


    print('This is ETH price: ' + str(eth_price))
    string = str(eth_price)
